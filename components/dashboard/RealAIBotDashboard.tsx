...
import { useRealBotStatus } from '@/hooks/useRealBotStatus'
...
import { useRealBotActivity } from '@/hooks/useRealBotActivity'
import { useRealBotControl } from '@/hooks/useRealBotControl'
import { RefreshCw, DollarSign, TrendingUp, Activity, AlertCircle, Play, Square } from "lucide-react"
...
export default function RealAIBotDashboard() {
  ...
  const { startBot, stopBot } = useRealBotControl()
