...
// Default bot configuration with expanded watchlist for increased opportunities
const defaultBotConfig = {
  ...
  watchlistSymbols: [
    // Mega Cap Tech (High Volume, 24/7 news flow)
    'AAPL', 'MSFT', 'GOOGL', 'AMZN', 'NVDA', 'META', 'TSLA',
    // AI & Semiconductor (High Volatility Opportunities)
    'AMD', 'INTC', 'PLTR', 'AI', 'SMCI', 'AVGO', 'QCOM',
    // High Volume ETFs (Market Proxies)
    'SPY', 'QQQ', 'IWM', 'XLK', 'XLF',
    // Growth & Momentum Stocks
    'NFLX', 'CRM', 'SHOP', 'ROKU', 'SNOW', 'CRWD',
    // Financial Services (Rate Sensitive)
    'JPM', 'BAC', 'V', 'MA', 'PYPL',
    // Energy & Materials (Commodity Plays)
    'XOM', 'CVX', 'NEM', 'FCX',
    // Consumer & Retail (Economic Indicators)
    'WMT', 'HD', 'COST', 'TGT', 'NKE'
  ]
}
